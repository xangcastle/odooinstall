...
apt-get update && apt-get install postgresql build-essential python3-pil python3-lxml python-ldap3 python3-dev python3-pip python3-setuptools npm nodejs git gdebi libldap2-dev libsasl2-dev  libxml2-dev libxslt1-dev libjpeg-dev libtiff-dev python3-pypdf2 libpq-dev -y
